...
class _ItineraryScreenState extends State<ItineraryScreen> {
  ...
  Future<void> _addItem() async {
    final item = await Navigator.of(context).push<ItineraryItem>(
      MaterialPageRoute(
        builder: (_) => AddItineraryItemScreen(
          trip: widget.trip,
        ),
      ),
    );
  ...
  Future<void> _editItem(
    ...
    final updatedItem =
        await Navigator.of(context).push<ItineraryItem>(
      MaterialPageRoute(
  ...
  Map<DateTime, List<ItineraryItem>>
      _groupItemsByDate() {
    final grouped =
        <DateTime, List<ItineraryItem>>{};
  ...
  Widget _buildSummaryCard(
    ...
    final bookedCount =
        _items.where((item) => item.isBooked).length;
