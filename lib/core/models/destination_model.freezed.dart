...
mixin _$Destination {
  ...
  List<String> get attractions => throw _privateConstructorUsedError;
  int get bestTimeToVisit => throw _privateConstructorUsedError;
...
class _$DestinationImpl implements _Destination {
  ...
  final List<String> _attractions;
  @override
  List<String> get attractions {
  ...
  @override
  final int bestTimeToVisit;

  @override
  String toString() {
    return 'Destination(id: $id, name: $name, country: $country, countryCode: $countryCode, flag: $flag, description: $description, rating: $rating, reviewCount: $reviewCount, imageUrl: $imageUrl, temperature: $temperature, weather: $weather, attractions: $attractions, bestTimeToVisit: $bestTimeToVisit)';
  }
